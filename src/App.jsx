...
socket.on('rejoin-success', ({ playerIndex, roomCode }) => {
    setMyPlayerIndex(playerIndex);
    setRoomCode(roomCode);
    setScreen('game');
});
  ...
  if (screen === 'lobby') return (
    <div style={{ minHeight: '100vh', background: '#1a472a', display: 'flex', alignItems: 'center', fontFamily: 'sans-serif', padding: 16 }}>
      <div style={{ background: 'rgba(255,255,255,0.1)', borderRadius: 16, padding: 32, width: '100%', maxWidth: 600, boxSizing: 'border-box', margin: '0 auto'}}>
